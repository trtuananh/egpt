...
name = 'egpt_tolstoy' # name of the model, used for saving checkpoints
dataset = 'tolstoy' # use the smaller openwebtext dataset for faster training
init_from = 'scratch' # 'scratch' or 'resume' or 'gpt2*'
# out_dir = os.path.join('out', 'epgt_long')
wandb_log = True
wandb_project = 'owt'
wandb_run_name='egpt-tolstoy'
