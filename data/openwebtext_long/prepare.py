...
MINIMUM_LENGTH = 16 * 1024  # Minimum length of sequences to keep
...
if __name__ == '__main__':
    ...
    split_dataset = filtered_dataset.train_test_split(test_size=0.1, seed=2357, shuffle=True)
    ...
    plt.hist(lengths, bins=100, range=(16384, max(lengths)), log=True)
