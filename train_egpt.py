...
from config import train_epgt_tolstoy as config
from config.train_epgt_tolstoy import *
...
# model init
model, checkpoint, model_args = EGPT.create(config=config, meta_vocab_size=meta_vocab_size)
